...
<pre><span style="font-size: 18px;"><strong>Input</strong>: <br>n = 4, k = 0
...
<pre><span style="font-size: 18px;"><strong>Input</strong>: <br>n = 4, k = 2
...
<pre><span style="font-size: 18px;"><strong>Input</strong>: <br>n = 500, k = 3
<strong>Output</strong>: <br>No
